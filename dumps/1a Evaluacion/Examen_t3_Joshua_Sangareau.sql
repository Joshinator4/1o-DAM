...
CREATE TABLE `entrega` (
  ...
  `vehiculo` char(1) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `pedido` (
  ...
  `domicilio` char(1) COLLATE utf8mb4_spanish2_ci NOT NULL DEFAULT 'N',
...
CREATE TABLE `repartidor` (
  `carnet` char(2) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `id_empleado` int NOT NULL,
  PRIMARY KEY (`id_empleado`),
...
-- Dump completed on 2023-11-30 21:01:22

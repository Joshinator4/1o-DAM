...
CREATE TABLE `contactos` (
  ...
  KEY `empresa` (`empresa`),
  KEY `idx_nombre` (`nombre` DESC),
  KEY `idx_apellido` (`apellidos`),
...
CREATE TABLE `empresas` (
  ...
  `pagina_web` varchar(100) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`cif`),
...
CREATE TABLE `nacionalidades` (
  `autor` int NOT NULL,
  `pais` char(3) COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`autor`,`pais`),
  KEY `pais` (`pais`),
  CONSTRAINT `nacionalidades_ibfk_1` FOREIGN KEY (`autor`) REFERENCES `autores` (`id_del_autor`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `preferencias` (
  ...
  CONSTRAINT `preferencias_ibfk_2` FOREIGN KEY (`autor`) REFERENCES `autores` (`id_del_autor`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productos` (
  ...
  `color` varchar(2) COLLATE utf8mb3_spanish_ci DEFAULT 'c',
  `idioma` varchar(15) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`id_del_producto`),
  KEY `empresa` (`empresa`),
  KEY `idx_titulo` (`titulo`),
  KEY `idx_fecha` (`fecha_de_publicacion` DESC),
...
CREATE TABLE `tematicas` (
  ...
  KEY `tema` (`tema`),
  CONSTRAINT `tematicas_ibfk_1` FOREIGN KEY (`producto`) REFERENCES `productos` (`id_del_producto`),
  CONSTRAINT `tematicas_ibfk_2` FOREIGN KEY (`tema`) REFERENCES `temas` (`id_del_tema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-17 19:13:44

...
CREATE TABLE `contactos` (
  ...
  `empresa` char(9) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
CREATE TABLE `ejemplares` (
  `signatura` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `empresas` (
  `cif` char(9) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `nombre` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `direccion` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `sede` char(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT 'es',
  PRIMARY KEY (`cif`),
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paises` (
  `codigo_pais` char(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `nombre` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `prestamos` (
  `ejemplar` char(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `socio` int NOT NULL,
...
CREATE TABLE `productos` (
  ...
  `titulo` char(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `fecha_de_publicacion` date NOT NULL,
  `empresa` char(9) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `tipo_de_producto` int NOT NULL DEFAULT '1',
  `isbn` char(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
-- Dump completed on 2024-05-17 23:50:19

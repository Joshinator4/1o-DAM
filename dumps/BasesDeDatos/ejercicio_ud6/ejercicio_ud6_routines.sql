...
--
-- Dumping events for database 'ejercicio_ud6'
--

--
-- Dumping routines for database 'ejercicio_ud6'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `descuento`(id int) RETURNS int
    READS SQL DATA
begin
	declare fecha date;
    declare devolucion int;
    
    set fecha = (select fecha_alta from clientes c where c.id = id);
...
/*!50003 DROP FUNCTION IF EXISTS `importe` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `importe`(id int) RETURNS double
    READS SQL DATA
begin
    ...
    if pedido is null then 
		...
		set devolucion = (select sum(precio * cantidad) from pedidos p
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `revisar_pedidos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `revisar_pedidos`()
begin 
	update pedidos 

...
public class Curso {
	...
	public Curso(String nombre, String descripcion, double precio, int maxAlumnos) {
		...
		this.alumnos = new String[maxAlumnos];
		contadorCurso++;
		
	}
	
	//este metodo añade al array de alumnos el dni de cada alumno
	public void matricularAlumno(String dniSocio) {
		this.alumnos[contadorAlumnos] = dniSocio;
		contadorAlumnos++;
	}

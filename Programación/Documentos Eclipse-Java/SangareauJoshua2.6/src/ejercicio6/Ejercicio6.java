...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		...
		//Creamos las condiciones para las notas generamos if para que si las notas son <0 o >10 se imprima en pantalla la nota academica es incorrecta. Usamos else if con <5 etc
		//con su respectiva nota cualitativa y else ya reconoce que el último nº es el 10
		...
		//Esta forma es como lo hice anteriormente pero es mejor hacerlo como me ha explicado Rafa y como ha quedado realizado finalmente
		...
		//else if (nota >= 9 && nota < 10) {
			//System.out.println("Nota académica: " + nota + " (Sobresaliente)");
			//}
		//Cambiamos la nota de por Matrícula de honor
		
		//else if (nota == 10) {
				//System.out.println("Nota académica: " + nota + " (Matrícula de Honor)");
			//}
		//Si la nota es menor que 0 o mayor que 10 imprimiremos en pantalla que la nota académica es incorrecta

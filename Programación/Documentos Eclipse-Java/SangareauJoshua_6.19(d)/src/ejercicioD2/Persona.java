...
public class Persona {
	...
	public void imprime() {
		System.out.printf("dni: %s, nombre: %s, apellidos: %s, edad: %d, es mayor de edad: %s, es jubilado: %s", getDni(), getNombre(), getApellidos(), getEdad(), siONo(esMayorEdad()), siONo(esJubilado()));
	}
	...
	public int diferenciaEdad(Persona p) {
		int devolucion;
		devolucion = Math.abs(this.edad - p.edad);
		return devolucion;
	}

...
public class Principal {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("Instanciando persona8");
			Persona persona8 = new Persona("05462865C","antonio", "jimenez", 18);
			System.out.println(persona8.toString());
			System.out.println("Imprimiendo datos con el metodo imprime()");
			persona8.imprime();
			System.out.println("probando metodo esMayorEdad(): " + persona8.esMayorEdad());
			Persona persona9 = new Persona("05462865C","raul", "garcia", 65);
			System.out.println("Probando metodo esJubilado(): " + persona9.esJubilado());
			System.out.println("Probando el metodo diferenciaEdad(): " + persona8.diferenciaEdad(persona9));

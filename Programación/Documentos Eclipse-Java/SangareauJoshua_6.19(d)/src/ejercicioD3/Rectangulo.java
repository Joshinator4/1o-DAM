...
public class Rectangulo {
	...
	public String toString() {
		return "el valor de la coordenada x1 es: " + this.x1 + ". El valor de la coordenada y1 es: " + this.y1
				+ "el valor de la coordenada x2 es: " + this.x2 + ". El valor de la coordenada y2 es: " + this.y2;
	}
	...
	public int getPerimetro() {
		int devolucion;
		devolucion = 2 * (this.x2 - this.x1) + 2 * (this.y2 - this.y1);
		return devolucion;
	}
	
	public int getArea() {
		int devolucion;
		devolucion = (this.x2 - this.x1) * (this.y2 - this.y1);
		return devolucion;
	}
}

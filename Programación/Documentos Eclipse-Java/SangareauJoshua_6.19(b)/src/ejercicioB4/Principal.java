...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Utilizo 5 bloques de try-catch porque cada constructor tiene un error diferente
		try {
		...
		try {
		System.out.println("Intentando Instanciaciar el articulo2");
		...
		try {
		System.out.println("Intentando Instanciaciar el articulo3");
		...
		try {
		System.out.println();
		System.out.println("Intentando Instanciaciar el articulo4");
		...
		try {
		System.out.println();
		System.out.println("Intentando Instanciaciar el articulo5");
		Articulo articulo5 = new Articulo( -15, 21, 4);
